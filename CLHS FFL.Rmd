...
```{r}
WinStreakData <- StreakChartData %>% 
  filter(Outcome == "Win")

WinStreakLevels <- WinStreakData %>%
...
WinStreakData$firstName <- factor(WinStreakData$firstName ,levels = WinStreakLevels)
